...
import { getRecentAnime } from "../../service/api";
  ...
  return (
    <div className="container mx-auto p-2">
      <section className="mb-8">
        <h1 className="text-xl font-bold mb-4 pb-2 border-b">Anime OnGoing</h1>
